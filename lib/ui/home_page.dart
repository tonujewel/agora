...
import '../dialog/create_room.dart';
import '../dialog/join_room.dart';
                            ...
                            Flexible(
                              ...
                              child: Column(
                                ...
                                children: [
                                  Text(
                                    "Create Room",
                                    style: largeTxtStyle.copyWith(color: const Color(0xFF1A1E78)),
                                  ),
                                  Text(
                                    "create a unique agora room and ask others to join the same.",
                                    style: regularTxtStyle.copyWith(color: const Color(0xFF1A1E78)),
                                  ),
                                ],
                              ),
                            ),
      ...
      floatingActionButton: FloatingActionButton(
        ...
        onPressed: () {
          Get.snackbar("You Liked ?", "Please ★ My Project On Git :) ",
              backgroundColor: Colors.white, colorText: const Color(0xFF1A1E78), snackPosition: SnackPosition.BOTTOM);
        },
      ),
    );
  }
