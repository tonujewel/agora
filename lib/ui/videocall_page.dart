...
class VideoCallScreenState extends State<VideoCallScreen> {
  ...
  void dispose() {
    ...
    agoraController.engine.leaveChannel();
  }
  ...
  Future<void> initAgoraRTC() async {
    ...
    await agoraController.engine
        .joinChannel(token: "null", channelId: widget.channelName, uid: 0, options: ChannelMediaOptions());
  }
  ...
  void _addAgoraEventHandlers() {
    agoraController.engine.onError = (dynamic code) {
    ...
    agoraController.engine.onUserJoined = (int uid, int elapsed) {
      print("======================================");
      print("             User Joined              ");
      print("======================================");
      if (agoraController.meetingTimer != null) {
      ...
      showDialog(
        ...
        builder: (context) => AlertDialog(
          ...
          content: Column(
            ...
            children: [
              Text("No one has not joined this call yet,\nDo You want to close this room?"),
            ],
          ),
          actions: <Widget>[
            FlatButton(
        ...
        bottomNavigationBar: GetBuilder<AgoraController>(builder: (_) {
          return ConvexAppBar(
            ...
            items: [
              ...
              TabItem(
                icon: _.muteVideo ? Icons.videocam_off_outlined : Icons.videocam_outlined,
              ),
            ],
